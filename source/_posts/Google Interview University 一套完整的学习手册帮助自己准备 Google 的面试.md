title: Google Interview University 一套完整的学习手册帮助自己准备 Google 的面试
date: 2018-09-30T02:09:47.539Z
tags: []
categories: []
---
...
- ### 堆栈（Stack）
    ...
    - [ ] [使用堆栈 —— 后进先出（视频）](hrructures/lecture/UdKzQ/stacks)
    - [ ] [使用堆栈 —— 后进先出（视频）](http现，因为使用数组来实现并不重要
...
- ### 哈希表（Hash table）
    ...
    - [ ] 在线课程：
        ...
        - [ ] [哈希表的语言支持（视频）](https://www.lynda.com/Develops/149042/177129-4.html)
...
- ### NP, NP-完全和近似算法
    ...
    - [ ] Skiena:
        - [ ] [CSE373 2012 - 课程m&index=18)
    - [ ] Skiena:
        - [ ] [CSE373 2012 - 课程 23Otl7M3yp-DV69F32zdK7YJcNXpTunF2b&t=1508)
...
- ### Unicode
    - [ ] [每一个软件开发者的绝对最低限cles/Unicode.html)
...
- [ ] [UC Berkeley 61B ((2006 年秋季): 数据结构 (39 个视频)]( https://www.youtube.com/playlist?lis=PL4BBB74C7D2A1049C)
